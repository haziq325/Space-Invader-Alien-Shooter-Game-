...
public:
    ...
    Explosion(const sf::Vector2f& position) {
        for (int i = 0; i < GameConfig::EXPLOSION_FRAMES; ++i) {
            sf::Texture tex;
            tex.loadFromFile("D:/OOP Project/assets/explotion/sprite_" + std::to_string(i) + ".png");
...
public:
    ...
    Boss() {
        for (int i = 0; i < 6; ++i) {
            sf::Texture tex;
            tex.loadFromFile("D:/OOP Project/assets/final_boss_animation/sprite_" + std::to_string(i) + ".png");
            frames.push_back(tex);
        }
        sprite.setTexture(frames[0]);
...
private:
    ...
    void loadResources() {
        // Font
        font.loadFromFile("D:/OOP Project/assets/main_font.ttf");
        if (!backgroundTexture.loadFromFile("D:/OOP Project/assets/background.png")) {
            // Error handling if needed
        }
        backgroundSprite.setTexture(backgroundTexture);
        // Sounds
        bgBuffer.loadFromFile("D:/OOP Project/assets/background_music.wav");
        shootBuffer.loadFromFile("D:/OOP Project/assets/shoot.wav");
        explosionBuffer.loadFromFile("D:/OOP Project/assets/explosion.wav");
        winBuffer.loadFromFile("D:/OOP Project/assets/win.wav");
        loseBuffer.loadFromFile("D:/OOP Project/assets/lost.wav");
        levelUpBuffer.loadFromFile("D:/OOP Project/assets/levelup.wav");
        levelCompleteBuffer.loadFromFile("D:/OOP Project/assets/levelcom.wav");
        bossBuffer.loadFromFile("D:/OOP Project/assets/boss.wav");
        // Health powerup sound (optional, fallback to shoot if not found)
        if (!healthPowerUpBuffer.loadFromFile("D:/OOP Project/assets/explosion.wav")) {
        ...
        // Textures
        playerTex.loadFromFile("D:/OOP Project/assets/sprite_ship_3.png");
        enemyTex.loadFromFile("D:/OOP Project/assets/big_boss1.png");
        bossTex.loadFromFile("D:/OOP Project/assets/final_boss_animation/sprite_0.png");

        bulletFrames.resize(5);
        for (int i = 0; i < 5; ++i) {
            bulletFrames[i].loadFromFile("D:/OOP Project/assets/blaster_player/sprite_" + std::to_string(i) + ".png");
        }
        level2EnemyFrames.resize(5);
        for (int i = 0; i < 5; ++i) {
            level2EnemyFrames[i].loadFromFile("D:/OOP Project/assets/invader_animation_2/sprite_" + std::to_string(i) + ".png");
        }
        // Health powerup texture
        healthPowerUpTex.loadFromFile("D:/OOP Project/assets/health.png");
